...
class StarterSupport {
    ...
    companion object {
        ...
        val frameworks =
            linkedMapOf(
                "flow" to "Flow / Java", "hilla-react" to "Hilla / React")
        ...
        fun supportsAllArchitectures(model: StarterModel): Boolean {
            return getSupport(model.framework)
                ?.architectures
                ?.containsAll(architectures.keys)!!
        }
